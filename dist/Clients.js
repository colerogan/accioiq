(() => {
  function Clients({ darkBg = "deep" }) {
    ...
    const items = [
      {
        ...
        stat: "16+",
        statLabel: "agents shipped across robotics, automotive and healthcare",
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "aq-on-dark", style: { background: bg, padding: isMobile ? "72px 20px" : "128px 40px" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1200, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { style: {
      ...
      margin: 0
    } }, "Organizations that have decided the usual options are not enough.")), /* @__PURE__ */ React.createElement("p", { style: {
    ...
    } }, "Select a client type below to see a real example of how we work with them.")), /* @__PURE__ */ React.createElement("div", { style: { borderTop: "1px solid rgba(216,228,220,.18)" } }, items.map((item, i) => /* @__PURE__ */ React.createElement("div", { key: item.t, style: { borderBottom: "1px solid rgba(216,228,220,.18)" } }, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      gap: isMobile ? 28 : 56
    } }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "aq-eyebrow", style: { color: "var(--aq-teal)", marginBottom: 12 } }, item.sector, " \xB7 ", item.client), /* @__PURE__ */ React.createElement("div", { style: {
      fontFamily: "var(--font-display)",
      fontStyle: "italic",
      fontWeight: 400,
      ...
      margin: "0 0 24px",
      maxWidth: "32ch"
    } }, item.headline), /* @__PURE__ */ React.createElement("p", { style: {
      fontFamily: "var(--font-body)",
      fontWeight: 300,
      ...
      color: "var(--aq-sage)",
      margin: 0
    } }, item.detail)), /* @__PURE__ */ React.createElement("div", { style: {
      ...
      lineHeight: 1
    } }, item.stat), /* @__PURE__ */ React.createElement("div", { style: {
      fontFamily: "var(--font-body)",
      fontWeight: 300,
      fontSize: 13,
      color: "var(--aq-sage)",
