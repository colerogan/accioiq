    ...
    <section id="philosophy" style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div style={{
          ...
          gap: isMobile ? 24 : 96, alignItems: 'start', marginBottom: isMobile ? 40 : 80,
        }}>
          <div>
          ...
          {phases.map((p, i) => (
            <button key={p.n}
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
                <span style={{
                  fontFamily: 'var(--font-display)', fontSize: isMobile ? 40 : 56, fontWeight: 400,
                  color: active === i ? 'var(--aq-teal-dark)' : 'var(--aq-deep)',
                  letterSpacing: '-0.02em', lineHeight: 1,
                  transition: 'color 320ms var(--ease-out)',
                }}>{p.n}</span>
                <span className="aq-eyebrow" style={{ color: 'var(--aq-sage)' }}>{p.tag}</span>
              </div>
              <h3 style={{
                fontFamily: 'var(--font-display)', fontWeight: 400, fontSize: isMobile ? 24 : 30,
